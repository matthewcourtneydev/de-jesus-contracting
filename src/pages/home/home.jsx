      ...
      <header className="flex flex-col-reverse md:flex-row ">
        ...
        <section className="right pb-9 pt-20 lg:pt-28 pl-5 pr-5 w-full h-full  md:w-1/2 lg:pr-24 min-h-100%">
          <h1 className="home-header flex flex-col">
            <span className="text-7xl md:ml-5 md:text-6xl lg:text-8xl leading-10 sm:mt-5 text-light">
              Precision
            </span>
            <span className=" text-light text-7xl md:ml-32 md:text-6xl lg:text-8xl leading-10 mt-7 sm:mt-5">
              Integrity
            </span>
            <span className="text-7xl sm:text-7xl md:ml-2 md:text-6xl lg:text-8xl sm:leading-10 sm:mt-5 flex flex-col md:flex-row">
              <p className="md:w-4/6 md:ml-10 text-light">Excellence</p>
          ...
          <button className="get-started text-light pt-2 pb-2 pl-5 pr-5 mt-5 sm:mt-10 sm:m-5 border-white border">
            GET STARTED
          </button>
        </section>
      </header>
        ...
        <div className="home-section-1-container mb-10 md:pt-10 md:flex md:flex-row">
          <div className="header-text md:w-3/5">
            ...
            <h2 className="sub-header mb-5 text-4xl flex flex-col md:text-5xl lg:text-7xl">
              <span className="leading-10 sm:text-light  sm:mt-2">HIGH-QUALITY</span>
              <span className="leading-10 sm:text-light mt-1 sm:mt-2 sm:ml-48">HOME</span>
              <span className="leading-10 sm:text-light mt-1 sm:mt-2 sm:ml-24">REMODELING</span>
            </h2>
          </div>
        ...
        <section className="text md:w-3/5">
          <div className="header-text">
            ...
            <h2 className="sub-header mb-5 text-4xl leading-10 sm:text-light sm:mt-2 md:text-5xl flex flex-col">
              <span className="text-light">READY TO BEGIN</span>
              <div className=" text-light md:w-screen relative z-10 mt-1 sm:ml-36 leading-12 sm:text-light sm:mt-2">A HOME REMODELING</div>
              <span className=" text-light sm:ml-12 leading-10 mt-1 sm:text-light sm:mt-2">PROJECT?</span>
            </h2>
          </div>
      ...
      <section className="whole-lite flex sm:pl-20 sm:pb-20 sm:pt-20 flex-col w-full md:flex-row md:flex-wrap p-5 lg:pl-28 lg:pr-28 lg:content-right">
        <div className="header-text sm:w-1/3 sm:order-4">
          ...
          <h2 className="sub-header mb-5 text-4xl leading-10 flex flex-col lg:text-right">
            <span className="sm:leading-10 sm:text-light sm:mt-2 md:text-5xl">HOW CAN</span>
            <span className="sm:leading-10 sm:text-light mt-1 sm:mt-2 md:text-5xl sm:mb-5">WE HELP?</span>
          </h2>
        </div>
